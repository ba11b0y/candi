...
\begin{figure*}[!h]
  \centering
  \includegraphics[width=0.95\textwidth]{high-level.jpg}
  \caption{High-level overview of the proposed methodology}
